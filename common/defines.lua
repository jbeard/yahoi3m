...
military = {
	...
	NAVAL_COMBAT_SUB_SURPRISE_BONUS = 3.0, -- Sub surprise attack bonus
...
diplomacy = {
	...
	NAP_UNBREAKABLE_MONTHS = 9,			-- NAPS cannot be broken for this many months
	NAP_FORCE_BALANCE_RULE_MONTHS = 9,		-- The NAP border force balance rule changes with this interval
